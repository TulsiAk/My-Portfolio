...
window.addEventListener('load', () => {
    ...
    if (heroTitle) {
        typeWriter(heroTitle, 'Tulsi Aakanksha', 150);
    }
});

// Smooth reveal animations for cards
const cards = document.querySelectorAll('.experience-card, .project-card, .achievement-card, .timeline-content');
        ...
        emailElement.addEventListener('click', () => {
            navigator.clipboard.writeText(emailElement.textContent.trim()).then(() => {
                ...
                setTimeout(() => {
                    ...
                    emailElement.style.color = 'var(--text-gray)';
                }, 2000);
            });
        });
    }
